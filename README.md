# Pholcus [![GitHub release](https://img.shields.io/github/release/maskwang/pholcus.svg?style=flat-square)](https://github.com/maskwang/pholcus/releases) [![report card](https://goreportcard.com/badge/github.com/maskwang/pholcus?style=flat-square)](http://goreportcard.com/report/maskwang/pholcus) [![github issues](https://img.shields.io/github/issues/maskwang/pholcus.svg?style=flat-square)](https://github.com/maskwang/pholcus/issues?q=is%3Aopen+is%3Aissue) [![github closed issues](https://img.shields.io/github/issues-closed-raw/maskwang/pholcus.svg?style=flat-square)](https://github.com/maskwang/pholcus/issues?q=is%3Aissue+is%3Aclosed) [![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg?style=flat-square)](http://godoc.org/github.com/maskwang/pholcus) [![view Go大数据](https://img.shields.io/badge/官方QQ群-Go大数据(42731170)-27a5ea.svg?style=flat-square)](http://jq.qq.com/?_wv=1027&k=XnGGnc)
...
![image](https://github.com/maskwang/pholcus/raw/master/doc/icon.png)


# 爬虫原理

![image](https://github.com/maskwang/pholcus/raw/master/doc/module.png)

&nbsp;

![image](https://github.com/maskwang/pholcus/raw/master/doc/project.png)

&nbsp;

![image](https://github.com/maskwang/pholcus/raw/master/doc/distribute.png)
...
```
go get -u -v github.com/maskwang/pholcus
```

备注：Pholcus公开维护的spider规则库地址 <https://github.com/maskwang/pholcus_lib>
...
import (
    "github.com/maskwang/pholcus/exec"
    _ "github.com/maskwang/pholcus_lib" // 此为公开维护的spider规则库
...
正常编译方法
```
cd {{replace your gopath}}/src/github.com/maskwang/pholcus
...
pholcus -h
```
![image](https://github.com/maskwang/pholcus/raw/master/doc/help.jpg)

&nbsp;

> *<font size="2">Web版操作界面截图如下：*

![image](https://github.com/maskwang/pholcus/raw/master/doc/webshow_1.png)

&nbsp;

> *<font size="2">GUI版操作界面之模式选择界面截图如下*

![image](https://github.com/maskwang/pholcus/raw/master/doc/guishow_0.jpg)
...
"github.com/maskwang/pholcus_lib" // 此为公开维护的spider规则库
```
> *<font size="2">（在此感谢以上开源项目的支持！）</font>*

# 开源协议

Pholcus（幽灵蛛）项目采用商业应用友好的[Apache License v2](https://github.com/maskwang/pholcus/raw/master/LICENSE).发布
